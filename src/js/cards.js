...
export default class Cards {
  ...
  addListeners(container) {
    container.addEventListener('click', (e) => {
      ...
      if (e.target.classList.contains('button-add-card')) {
        const {
          value
        } = e.target.closest('.textarea-field').querySelector('.textarea');
  ...
  onDragStart(e) {
    ...
    newElem.style.height = `$ {
      this.activeDragElement.offsetHeight
    }px`;
    newElem.style.backgroundColor = '#eeeeee';
  ...
  onDrag(e) {
    ...
    this.activeDragElement.style.top = `$ {
      e.clientY - this.elementTop + window.scrollY
    }px`;
    this.activeDragElement.style.left = `$ {
      e.clientX - this.elementLeft + window.scrollX
    }px`;
    this.activeDragElement.style.width = `$ {
      this.activeDragElementWidth
    }px`;
